...
const Landmark = createLucideIcon("landmark", __iconNode$y);
const __iconNode$x = [
...
const Leaf = createLucideIcon("leaf", __iconNode$w);
...
const ShoppingBasket = createLucideIcon("shopping-basket", __iconNode$b);
const __iconNode$a = [
