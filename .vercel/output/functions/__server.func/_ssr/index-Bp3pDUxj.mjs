...
import { c as categories, P as ProductCard, p as products } from "./products-BdahJgXQ.mjs";
import { v as vendorImg } from "./vendor-market-C2Vjh_h4.mjs";
import { r as riderImg } from "./delivery-rider-CE12BY6d.mjs";
import "../_libs/sonner.mjs";
import { k as Sparkles, A as ArrowRight, h as Truck, l as Leaf, j as Clock, m as Snowflake, n as ShieldCheck, b as Store, B as Bike } from "../_libs/lucide-react.mjs";
...
const heroImg = "/assets/hero-groceries-Dwj6u2s0.jpg";
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-10 px-4 pb-20 pt-14 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:pb-28 lg:pt-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex w-fit items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-xs font-medium text-primary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-hidden rounded-[2rem] shadow-[var(--shadow-card)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: "Overhead arrangement of fresh groceries: tomatoes, leafy greens, avocado, bread and eggs", width: 1600, height: 1200, className: "h-full w-full object-cover" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-4 -top-4 hidden rounded-2xl border border-border bg-card p-4 shadow-[var(--shadow-warm)] sm:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-xl bg-accent/20 text-accent-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "h-5 w-5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "Freshness guaranteed" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "or your money back" })
            ] })
          ] }) })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4", children: categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: {
        category: c.name
      }, className: "group flex flex-col gap-3 rounded-3xl border border-border/60 bg-card p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-[var(--shadow-card)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-14 w-14 place-items-center rounded-2xl bg-[image:var(--gradient-hero)] text-3xl", children: c.emoji }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
